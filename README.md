...
The latest version of this app was built using Ruby 2.6.0, but it should work on any Ruby >= 2.3. It also requires Postgres >= 9.5, Node >= 10 and Yarn >= 1.9.
...
1. `rvm rvmrc create ruby-2.6.0@gmmcal.com.br --ruby-version` to create a gemset for this project.

...
Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "gmmcal_com_br_production"
...
Rails.application.configure do
  ...
  # Enforce secure protocol for URL generated by helpers
  config.action_controller.default_url_options = { protocol: :https }

  if ENV["CDN_HOSTS"].present?
    config.middleware.insert_before 0, Rack::Cors do
      allow do
        origins ENV['CDN_HOSTS'].split(',')
